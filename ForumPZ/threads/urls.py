...
from threads.views import ThreadCreateView, CommentCreateView, ListCommentsView, AllowUserView, DenyUserView, ListOfAllowedUsersView, PublicThreadListView, ThreadDetailView
...
urlpatterns = [
    ...
    path('api/threads/', PublicThreadListView.as_view(), name='thread-list'),
]